...
//    boolean isDown2=false;
   ...
   int treeSpeed = 3;
    ...
    int difficultyLevel = 1; // مستوى الصعوبة الافتراضي (سهل)
    double[] difficultySpeedIncrease = {0.5, 1.5};
    ...
    String[] textureNames = { "frame_00_delay-0.08s.png","frame_01_delay-0.08s.png","frame_02_delay-0.08s.png","frame_03_delay-0.08s.png","frame_04_delay-0.08s.png","frame_05_delay-0.08s.png","frame_06_delay-0.08s.png","frame_07_delay-0.08s.png","frame_08_delay-0.08s.png","frame_09_delay-0.08s.png",
            ...
            "frame_60_delay-0.08s.png" ,"playerOne-1.png","playerOne-2.png","playerOne-3.png","playerOne-1.png","rock4.png","rock5.png","rock6.png","playerTwo-2.png","playerTwo-3.png","playerTwo-1.png","how-to-play.png","you-win.png","go-back-to-menu.png","instructions.png","start-game.png", "level-1.png" ,
            "level-2.png","select.png","one-player.png","two-players.png","exit.png","T-ReX-GAME.png" ,"T-rexBG.png"
    }; //68 69 70
...
//        }
        ...
        if (key == KeyEvent.VK_UP) {
            selectedOption = (selectedOption - 1 + 6) % 6; // Wrap around
        }

        // Down arrow key moves the selection down
        if (key == KeyEvent.VK_DOWN) {
            selectedOption = (selectedOption + 1) % 6;// Wrap around
//             isDown1=true;
    ...
    public void DrawMenu(GL gl) {
        ...
        int onePlayerY = startGameY - 6;  // 8 units below Start Game
        ...
        // Draw "2-Players"
        int twoPlayersX = 45;
        int twoPlayersY = onePlayerY - 4; // 8 units below 1-Player
        ...
        // Draw "level one"
        int easyX = 45;
        int easyY = twoPlayersY-4;
        float easyScaleX = 0.25f;
        float easyScaleY = 0.05f;
        DrawSprite(gl, easyX, easyY, textures.length - 8, easyScaleX, easyScaleY);

        // Draw "level 2"
        int mediumX = 45;
        int mediumY = easyY - 4;
        DrawSprite(gl, mediumX, mediumY, textures.length - 7, easyScaleX, easyScaleY);


        // Draw "Exit"
        int exitX = 45;
        int exitY = mediumY - 4; // 8 units below 2-Players
...
//        }
    ...
    public void handleMenuSelection() {
        switch (selectedOption) {
            ...
            case 2:
                ...
                break;
            case 3:
                System.out.println("Level median");
                startGame1();
                break;
            case 4:
    ...
    public void startGame1() {
        isGameStarted1 = true;
        if (score1 % 5 == 0) {
            treeSpeed += difficultySpeedIncrease[difficultyLevel - 1];
        }
    }
